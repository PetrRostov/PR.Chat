    ...
    public partial class ExpressionSerializer
    {
        ...
        public XElement GenerateXmlFromExpressionCore(Expression e)
        {
            ...
            else if (e is ConstantExpression)
            {
                ...
                //return e.Type.Name.IndexOf("<>c__DisplayClass") == -1
                //    ? ConstantExpressionToXElement((ConstantExpression)e)
                //    : ConstantExpressionWithClosureToXElement((ConstantExpression)e);
            }
        ...
        internal XElement ConstantExpressionToXElement(ConstantExpression constantExpression)
        {
            
            var lambda = Expression.Lambda(constantExpression).Compile();
            object value = lambda.DynamicInvoke(null);

            var e = Expression.Constant(value, value.GetType());
